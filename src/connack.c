...
//   name                                   dtype           bp  value           valloc  vlen    vexists link                            propid                                          flagid  idx                                         u8vlen  pvalloc     pvalue
    {"packet_type",                         MR_U8_DTYPE,    NA, MQTT_CONNACK,   false,  1,      true,   NA,                             NA,                                             NA,     CONNACK_PACKET_TYPE,                        0,      false,      NULL},
    {"remaining_length",                    MR_VBI_DTYPE,   NA, 0,              false,  0,      true,   CONNACK_AUTHENTICATION_DATA,    NA,                                             NA,     CONNACK_REMAINING_LENGTH,                   0,      false,      NULL},
    {"session_present",                     MR_BITS_DTYPE,  0,  0,              false,  1,      true,   CONNACK_MR_FLAGS,               NA,                                             NA,     CONNACK_SESSION_PRESENT,                    0,      false,      NULL},
    {"reserved",                            MR_BITS_DTYPE,  1,  0,              false,  7,      true,   CONNACK_MR_FLAGS,               NA,                                             NA,     CONNACK_RESERVED,                           0,      false,      NULL},
    {"mr_flags",                            MR_FLAGS_DTYPE, NA, 0,              false,  1,      true,   NA,                             NA,                                             NA,     CONNACK_MR_FLAGS,                           0,      false,      NULL},
    {"connect_reason_code",                 MR_U8_DTYPE,    NA, 0,              false,  0,      true,   NA,                             NA,                                             NA,     CONNACK_CONNECT_REASON_CODE,                0,      false,      NULL},
    {"property_length",                     MR_VBI_DTYPE,   NA, 0,              false,  0,      true,   CONNACK_AUTHENTICATION_DATA,    NA,                                             NA,     CONNACK_PROPERTY_LENGTH,                    0,      false,      NULL},
    {"mr_properties",                       MR_PROPS_DTYPE, NA, (Word_t)MRCP,   false,  MRCPSZ, true,   NA,                             NA,                                             NA,     CONNACK_MR_PROPERTIES,                      0,      false,      NULL},
    {"session_expiry_interval",             MR_U32_DTYPE,   NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_SESSION_EXPIRY_INTERVAL,              NA,     CONNACK_SESSION_EXPIRY_INTERVAL,            0,      false,      NULL},
    {"receive_maximum",                     MR_U16_DTYPE,   NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_RECEIVE_MAXIMUM,                      NA,     CONNACK_RECEIVE_MAXIMUM,                    0,      false,      NULL},
    {"maximum_qos",                         MR_U8_DTYPE,    NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_MAXIMUM_QOS,                          NA,     CONNACK_MAXIMUM_QOS,                        0,      false,      NULL},
    {"retain_available",                    MR_U8_DTYPE,    NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_RETAIN_AVAILABLE,                     NA,     CONNACK_RETAIN_AVAILABLE,                   0,      false,      NULL},
    {"maximum_packet_size",                 MR_U32_DTYPE,   NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_MAXIMUM_PACKET_SIZE,                  NA,     CONNACK_MAXIMUM_PACKET_SIZE,                0,      false,      NULL},
    {"assigned_client_identifier",          MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_ASSIGNED_CLIENT_IDENTIFIER,           NA,     CONNACK_ASSIGNED_CLIENT_IDENTIFIER,         0,      false,      NULL},
    {"topic_alias_maximum",                 MR_U16_DTYPE,   NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_TOPIC_ALIAS_MAXIMUM,                  NA,     CONNACK_TOPIC_ALIAS_MAXIMUM,                0,      false,      NULL},
    {"reason_string",                       MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_REASON_STRING,                        NA,     CONNACK_REASON_STRING,                      0,      false,      NULL},
    {"user_properties",                     MR_SPV_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_USER_PROPERTY,                        NA,     CONNACK_USER_PROPERTIES,                    0,      false,      NULL},
    {"wildcard_subscription_available",     MR_U8_DTYPE,    NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_WILDCARD_SUBSCRIPTION_AVAILABLE,      NA,     CONNACK_WILDCARD_SUBSCRIPTION_AVAILABLE,    0,      false,      NULL},
    {"subscription_identifiers_available",  MR_U8_DTYPE,    NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_SUBSCRIPTION_IDENTIFIERS_AVAILABLE,   NA,     CONNACK_WILDCARD_SUBSCRIPTION_AVAILABLE,    0,      false,      NULL},
    {"shared_subscription_available",       MR_U8_DTYPE,    NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_SHARED_SUBSCRIPTION_AVAILABLE,        NA,     CONNACK_SHARED_SUBSCRIPTION_AVAILABLE,      0,      false,      NULL},
    {"server_keep_alive",                   MR_U16_DTYPE,   NA, 0,              false,  0,      false,  NA,                             MQTT_PROP_SERVER_KEEP_ALIVE,                    NA,     CONNACK_SERVER_KEEP_ALIVE,                  0,      false,      NULL},
    {"response_information",                MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_RESPONSE_INFORMATION,                 NA,     CONNACK_RESPONSE_INFORMATION,               0,      false,      NULL},
    {"server_reference",                    MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_SERVER_REFERENCE,                     NA,     CONNACK_SERVER_REFERENCE,                   0,      false,      NULL},
    {"authentication_method",               MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_AUTHENTICATION_METHOD,                NA,     CONNACK_AUTHENTICATION_METHOD,              0,      false,      NULL},
    {"authentication_data",                 MR_U8V_DTYPE,   NA, (Word_t)NULL,   false,  0,      false,  NA,                             MQTT_PROP_AUTHENTICATION_DATA,                  NA,     CONNACK_AUTHENTICATION_DATA,                0,      false,      NULL}
