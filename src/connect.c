...
//   name                           dtype               value           valloc  vlen    vexists link                            id                                      idx                                     ualloc u8vlen  u8v0
    ...
    {"session_expiry_interval",     MR_PROP_U32_DTYPE,  0,              false,  5,      false,  0,                              MQTT_PROP_SESSION_EXPIRY_INTERVAL,      CONNECT_SESSION_EXPIRY_INTERVAL,        false,  0,      NULL},
    {"receive_maximum",             MR_PROP_U16_DTYPE,  0,              false,  3,      false,  0,                              MQTT_PROP_RECEIVE_MAXIMUM,              CONNECT_RECEIVE_MAXIMUM,                false,  0,      NULL},
    {"maximum_packet_size",         MR_PROP_U32_DTYPE,  0,              false,  5,      false,  0,                              MQTT_PROP_MAXIMUM_PACKET_SIZE,          CONNECT_MAXIMUM_PACKET_SIZE,            false,  0,      NULL},
    {"topic_alias_maximum",         MR_PROP_U16_DTYPE,  0,              false,  3,      false,  0,                              MQTT_PROP_TOPIC_ALIAS_MAXIMUM,          CONNECT_TOPIC_ALIAS_MAXIMUM,            false,  0,      NULL},
    {"request_response_information",MR_PROP_U8_DTYPE,   0,              false,  2,      false,  0,                              MQTT_PROP_REQUEST_RESPONSE_INFORMATION, CONNECT_REQUEST_RESPONSE_INFORMATION,   false,  0,      NULL},
