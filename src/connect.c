...
//   name                           dtype           value           valloc  vlen    vexists link                            xf                                      idx                                     ualloc u8vlen  u8v0
    ...
    {"protocol_name",               MR_U8V_DTYPE,   (Word_t)PNM,    false,  PNMSZ,  true,   0,                              NA,                                     CONNECT_PROTOCOL_NAME,                  false,  0,      NULL},
    ...
    {"will_flag",                   MR_BITS_DTYPE,  0,              false,  1,      true,   CONNECT_MR_FLAGS,               2,                                      CONNECT_WILL_FLAG,                      false,  0,      NULL},
    {"will_qos",                    MR_BITS_DTYPE,  0,              false,  2,      true,   CONNECT_MR_FLAGS,               3,                                      CONNECT_WILL_QOS,                       false,  0,      NULL},
    {"will_retain",                 MR_BITS_DTYPE,  0,              false,  1,      true,   CONNECT_MR_FLAGS,               5,                                      CONNECT_WILL_RETAIN,                    false,  0,      NULL},
    {"password_flag",               MR_BITS_DTYPE,  0,              false,  1,      true,   CONNECT_MR_FLAGS,               6,                                      CONNECT_PASSWORD_FLAG,                  false,  0,      NULL},
    {"username_flag",               MR_BITS_DTYPE,  0,              false,  1,      true,   CONNECT_MR_FLAGS,               7,                                      CONNECT_USERNAME_FLAG,                  false,  0,      NULL},
    {"mr_flags",                    MR_U8_DTYPE,    NA,             false,  1,      true,   0,                              NA,                                     CONNECT_MR_FLAGS,                       false,  0,      NULL},
    {"keep_alive",                  MR_U16_DTYPE,   0,              false,  2,      true,   0,                              NA,                                     CONNECT_KEEP_ALIVE,                     false,  0,      NULL},
    {"property_length",             MR_VBI_DTYPE,   0,              false,  0,      true,   CONNECT_AUTHENTICATION_DATA,    NA,                                     CONNECT_PROPERTY_LENGTH,                false,  0,      NULL},
    {"mr_properties",               MR_PROPS_DTYPE, (Word_t)MRCP,   false,  MRCPSZ, true,   0,                              NA,                                     CONNECT_MR_PROPERTIES,                  false,  0,      NULL},
    {"session_expiry_interval",     MR_U32_DTYPE,   0,              false,  5,      false,  0,                              MQTT_PROP_SESSION_EXPIRY_INTERVAL,      CONNECT_SESSION_EXPIRY_INTERVAL,        false,  0,      NULL},
    {"receive_maximum",             MR_U16_DTYPE,   0,              false,  3,      false,  0,                              MQTT_PROP_RECEIVE_MAXIMUM,              CONNECT_RECEIVE_MAXIMUM,                false,  0,      NULL},
    {"maximum_packet_size",         MR_U32_DTYPE,   0,              false,  5,      false,  0,                              MQTT_PROP_MAXIMUM_PACKET_SIZE,          CONNECT_MAXIMUM_PACKET_SIZE,            false,  0,      NULL},
    {"topic_alias_maximum",         MR_U16_DTYPE,   0,              false,  3,      false,  0,                              MQTT_PROP_TOPIC_ALIAS_MAXIMUM,          CONNECT_TOPIC_ALIAS_MAXIMUM,            false,  0,      NULL},
    {"request_response_information",MR_U8_DTYPE,    0,              false,  2,      false,  0,                              MQTT_PROP_REQUEST_RESPONSE_INFORMATION, CONNECT_REQUEST_RESPONSE_INFORMATION,   false,  0,      NULL},
    {"request_problem_information", MR_U8_DTYPE,    0,              false,  2,      false,  0,                              MQTT_PROP_REQUEST_PROBLEM_INFORMATION,  CONNECT_REQUEST_PROBLEM_INFORMATION,    false,  0,      NULL},
    {"user_properties",             MR_SPV_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_USER_PROPERTY,                CONNECT_USER_PROPERTIES,                false,  0,      NULL},
    {"authentication_method",       MR_STR_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_AUTHENTICATION_METHOD,        CONNECT_AUTHENTICATION_METHOD,          false,  0,      NULL},
    {"authentication_data",         MR_U8V_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_AUTHENTICATION_DATA,          CONNECT_AUTHENTICATION_DATA,            false,  0,      NULL},
    ...
    {"mr_will_properties",          MR_PROPS_DTYPE, (Word_t)MRCWP,  false,  MRCWPSZ,false,  0,                              NA,                                     CONNECT_MR_WILL_PROPERTIES,             false,  0,      NULL},
    {"will_delay_interval",         MR_U32_DTYPE,   0,              false,  5,      false,  0,                              MQTT_PROP_WILL_DELAY_INTERVAL,          CONNECT_WILL_DELAY_INTERVAL,            false,  0,      NULL},
    {"payload_format_indicator",    MR_U8_DTYPE,    0,              false,  2,      false,  0,                              MQTT_PROP_PAYLOAD_FORMAT_INDICATOR,     CONNECT_PAYLOAD_FORMAT_INDICATOR,       false,  0,      NULL},
    {"message_expiry_interval",     MR_U32_DTYPE,   0,              false,  5,      false,  0,                              MQTT_PROP_MESSAGE_EXPIRY_INTERVAL,      CONNECT_MESSAGE_EXPIRY_INTERVAL,        false,  0,      NULL},
    {"content_type",                MR_STR_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_CONTENT_TYPE,                 CONNECT_CONTENT_TYPE,                   false,  0,      NULL},
    {"response_topic",              MR_STR_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_RESPONSE_TOPIC,               CONNECT_RESPONSE_TOPIC,                 false,  0,      NULL},
    {"correlation_data",            MR_U8V_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_CORRELATION_DATA,             CONNECT_CORRELATION_DATA,               false,  0,      NULL},
    {"will_user_properties",        MR_SPV_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_RESPONSE_INFORMATION,         CONNECT_WILL_USER_PROPERTIES,           false,  0,      NULL},
    {"will_topic",                  MR_STR_DTYPE,   (Word_t)NULL,   false,  0,      false,  0,                              NA,                                     CONNECT_WILL_TOPIC,                     false,  0,      NULL},
