...
//   name                           dtype           bp  value           valloc  vlen    u8vlen  vexists link                            propid                                  flagid                  idx                                     pvalloc     pvalue
    ...
    {"protocol_name",               MR_U8V_DTYPE,   NA, (Word_t)PNM,    false,  PNMSZ,  PNMSZ+2,true,   NA,                             NA,                                     NA,                     CONNECT_PROTOCOL_NAME,                  false,      NULL},
    ...
    {"mr_properties",               MR_PROPS_DTYPE, NA, (Word_t)MRCP,   false,  MRCPSZ, NA,     true,   NA,                             NA,                                     NA,                     CONNECT_MR_PROPERTIES,                  false,      NULL},
    ...
    {"user_properties",             MR_SPV_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_USER_PROPERTY,                NA,                     CONNECT_USER_PROPERTIES,                false,      NULL},
    {"authentication_method",       MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_AUTHENTICATION_METHOD,        NA,                     CONNECT_AUTHENTICATION_METHOD,          false,      NULL},
    {"authentication_data",         MR_U8V_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_AUTHENTICATION_DATA,          NA,                     CONNECT_AUTHENTICATION_DATA,            false,      NULL},
    {"client_identifier",           MR_STR_DTYPE,   NA, (Word_t)"",     false,  1,      1,      true,   NA,                             NA,                                     NA,                     CONNECT_CLIENT_IDENTIFIER,              false,      NULL},
    ...
    {"mr_will_properties",          MR_PROPS_DTYPE, NA, (Word_t)MRCWP,  false,  MRCWPSZ,NA,     false,  NA,                             NA,                                     CONNECT_WILL_FLAG,      CONNECT_MR_WILL_PROPERTIES,             false,      NULL},
    ...
    {"content_type",                MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_CONTENT_TYPE,                 NA,                     CONNECT_CONTENT_TYPE,                   false,      NULL},
    {"response_topic",              MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_RESPONSE_TOPIC,               NA,                     CONNECT_RESPONSE_TOPIC,                 false,      NULL},
    {"correlation_data",            MR_U8V_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_CORRELATION_DATA,             NA,                     CONNECT_CORRELATION_DATA,               false,      NULL},
    {"will_user_properties",        MR_SPV_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             MQTT_PROP_USER_PROPERTY,                NA,                     CONNECT_WILL_USER_PROPERTIES,           false,      NULL},
    {"will_topic",                  MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             NA,                                     CONNECT_WILL_FLAG,      CONNECT_WILL_TOPIC,                     false,      NULL},
    {"will_payload",                MR_U8V_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             NA,                                     CONNECT_WILL_FLAG,      CONNECT_WILL_PAYLOAD,                   false,      NULL},
    {"user_name",                   MR_STR_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             NA,                                     CONNECT_USERNAME_FLAG,  CONNECT_USER_NAME,                      false,      NULL},
    {"password",                    MR_U8V_DTYPE,   NA, (Word_t)NULL,   false,  0,      0,      false,  NA,                             NA,                                     CONNECT_PASSWORD_FLAG,  CONNECT_PASSWORD,                       false,      NULL}
