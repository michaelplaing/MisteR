...
//   name                           dtype               value           valloc  vlen    vexists link                            id                                      idx                                     ualloc u8vlen  u8v0
    ...
    {"user_properties",             MR_PROP_SPV_DTYPE,  (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_USER_PROPERTY,                CONNECT_USER_PROPERTIES,                false,  0,      NULL},
    ...
    {"content_type",                MR_PROP_STR_DTYPE,  (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_CONTENT_TYPE,                 CONNECT_CONTENT_TYPE,                   false,  0,      NULL},
    {"response_topic",              MR_PROP_STR_DTYPE,  (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_RESPONSE_TOPIC,               CONNECT_RESPONSE_TOPIC,                 false,  0,      NULL},
    {"correlation_data",            MR_PROP_U8V_DTYPE,  (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_CORRELATION_DATA,             CONNECT_CORRELATION_DATA,               false,  0,      NULL},
    {"will_user_properties",        MR_PROP_SPV_DTYPE,  (Word_t)NULL,   false,  0,      false,  0,                              MQTT_PROP_RESPONSE_INFORMATION,         CONNECT_WILL_USER_PROPERTIES,           false,  0,      NULL},
