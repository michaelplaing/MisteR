...
//  Fixed Header
//   name                   index                       link        
//      function            value           bitpos  vlen    exists  id      isalloc buflen  buf
    {"packet_type",         CONNECT_PACKET_TYPE,        0,         
        pack_uint8,         CMD_CONNECT,    NA,     1,      true,   NA,     false,  0,      NULL},
...
//      function            value           bitpos  vlen    exists  id      isalloc buflen  buf
    ...
    {"protocol_version",    CONNECT_PROTOCOL_VERSION,   0,         
        pack_uint8,         PROTO_VER,      NA,     2,      true,   NA,     false,  0,      NULL},
    ...
    {"clean_start",         CONNECT_CLEAN_START,        CONNECT_FLAGS,    
        pack_in_parent,     0,              1,      1,      true,   NA,     false,  0,      NULL},
    {"will_flag",           CONNECT_WILL_FLAG,          CONNECT_FLAGS,    
        pack_in_parent,     0,              2,      1,      true,   NA,     false,  0,      NULL},
    {"will_qos",            CONNECT_WILL_QOS,           CONNECT_FLAGS,    
        pack_in_parent,     0,              3,      2,      true,   NA,     false,  0,      NULL},
    {"will_retain",         CONNECT_WILL_RETAIN,        CONNECT_FLAGS,    
        pack_in_parent,     0,              5,      1,      true,   NA,     false,  0,      NULL},
    {"password_flag",       CONNECT_PASSWORD_FLAG,      CONNECT_FLAGS,    
        pack_in_parent,     0,              6,      1,      true,   NA,     false,  0,      NULL},
    {"username_flag",       CONNECT_USERNAME_FLAG,      CONNECT_FLAGS,    
        pack_in_parent,     0,              7,      1,      true,   NA,     false,  0,      NULL},
    {"flags",               CONNECT_FLAGS,              0, // not in protocol - used for allocation of bits
        pack_flags_alloc,   NA,             NA,     1,      true,   NA,     false,  0,      NULL},
    {"keep_alive",          CONNECT_KEEP_ALIVE,         0,         
        pack_uint16,        0,              NA,     2,      true,   NA,     false,  0,      NULL},
...
//      function            value           bitpos  vlen    exists  id      isalloc buflen  buf
    ...
    {"session_expiry",      CONNECT_SESSION_EXPIRY,     0,         
        pack_sprop_uint32,  0,              NA,     0,      false,  0x11,   false,  0,      NULL},
    {"receive_maximum",     CONNECT_RECEIVE_MAXIMUM,    0,         
        pack_sprop_uint16,  0,              NA,     0,      false,  0x21,   false,  0,      NULL},
    {"maximum_packet_size", CONNECT_MAXIMUM_PACKET_SIZE,0,         
        pack_sprop_uint32,  0,              NA,     0,      false,  0x27,   false,  0,      NULL},
    {"topic_alias_maximum", CONNECT_TOPIC_ALIAS_MAXIMUM,0,         
        pack_sprop_uint16,  0,              NA,     0,      false,  0x22,   false,  0,      NULL},
    {"request_response_information",
                            CONNECT_REQUEST_RESPONSE_INFORMATION,
                                                        0,         
        pack_sprop_uint8,   0,              NA,     0,      false,  0x19,   false,  0,      NULL},
    {"request_problem_information",
                            CONNECT_REQUEST_PROBLEM_INFORMATION,
                                                        0,         
        pack_sprop_uint8,   0,              NA,     0,      false,  0x17,   false,  0,      NULL},
    {"user_properties",     CONNECT_USER_PROPERTIES,    0,         
        pack_mprop_strpair, (Word_t)NULL,   NA,     0,      false,  0x26,   false,  0,      NULL},
    {"authentication_method",
                            CONNECT_AUTHENTICATION_METHOD,
                                                        0,         
        pack_sprop_str,     (Word_t)NULL,   NA,     0,      false,  0x15,   false,  0,      NULL},
    {"authentication_data", CONNECT_AUTHENTICATION_DATA,0,         
        pack_sprop_char_buf,(Word_t)NULL,   NA,     0,      false,  0x16,   false,  0,      NULL},
// Payload
//   name                   index                       link        
//      function            value           bitpos  vlen    exists  id      isalloc buflen  buf
    {"client_identifier",   CONNECT_CLIENT_IDENTIFIER,  0,         
        pack_str,           (Word_t)NULL,   NA,     0,      false,  NA,     false,  0,      NULL},
// Payload Will Properties
    ...
    {"will_delay_interval", CONNECT_WILL_DELAY_INTERVAL,0,         
        pack_sprop_uint32,  0,              NA,     0,      false,  0x18,   false,  0,      NULL},
    {"payload_format_indicator",
                            CONNECT_PAYLOAD_FORMAT_INDICATOR,
                                                        0,         
        pack_sprop_uint8,   0,              NA,     0,      false,  0x01,   false,  0,      NULL},
    {"message_expiry_interval",
                            CONNECT_MESSAGE_EXPIRY_INTERVAL,
                                                        0,         
        pack_sprop_uint32,  0,              NA,     0,      false,  0x02,   false,  0,      NULL},
    {"content_type",        CONNECT_CONTENT_TYPE,       0,         
        pack_sprop_str,     (Word_t)NULL,   NA,     0,      false,  0x03,   false,  0,      NULL},
    {"response_topic",      CONNECT_RESPONSE_TOPIC,     0,         
        pack_sprop_str,     (Word_t)NULL,   NA,     0,      false,  0x08,   false,  0,      NULL},
    {"correlation_data",    CONNECT_CORRELATION_DATA,   0,         
        pack_sprop_char_buf,(Word_t)NULL,   NA,     0,      false,  0x09,   false,  0,      NULL},
...
// Payload (remainder)
    ...
    {"will_payload",        CONNECT_WILL_PAYLOAD,       0,         
        pack_char_buf,      (Word_t)NULL,   NA,     0,      false,  NA,     false,  0,      NULL},
...
pack_ctx *init_connect_pctx(void) {
    ...
    return init_pack_context(CONNECT_MDATA_TEMPLATE, mdata_count);
}
