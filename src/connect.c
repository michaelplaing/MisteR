...
//   name                           dtype           bp  value           valloc  vlen    u8vlen  vexists link                            propid                                  flagid                  idx                                     pvalloc     pvalue
    ...
    {"mr_properties",               MR_PROPS_DTYPE, NA, (Word_t)MRCP,   false,  MRCPSZ, 0,      true,   NA,                             NA,                                     NA,                     CONNECT_MR_PROPERTIES,                  false,      NULL},
    ...
    {"mr_will_properties",          MR_PROPS_DTYPE, NA, (Word_t)MRCWP,  false,  MRCWPSZ,0,      false,  NA,                             NA,                                     CONNECT_WILL_FLAG,      CONNECT_MR_WILL_PROPERTIES,             false,      NULL},
